    ...
    <div >
      <form onSubmit={(e) => { submitHandler(e) }} className=' flex w-full flex-wrap bg-gray-800 items-start  justify-between rounded-xl mt-10 p-5'>
        <div className='w-1/2 mx- p-5 rounded-xl'>
          <div>
            <div><h3>Task Title</h3>
              <input value={taskTitle}
                ...
                type="text" placeholder='Make a ui Design' className='p-1 text-lg border-2 border-gray-500 w-[70%] rounded-md mb-3' /></div>
            <h3>Date</h3>
            <input
              value={tasktDate}
          ...
          <div><h3>Catagory</h3>
            <input
              ...
              type="text" placeholder='Design , Dev ,etc' className='p-1  text-lg  border-2 border-gray-500 w-[70%] rounded-md mb-3' /></div>
        </div>
        ...
        <div className='w-2/5 flex flex-col items-start p-5' ><h3>Description</h3>
          ...
          <button className='p-2 text-lg border-2 bg-blue-600 border-gray-500 w-[70%] rounded-lg mb-3 '>Create Task</button>
        </div>
